...
#define DEMO_BUTTON 20 // Used for an optional external button to allow the hand to run through a series of canned poses
...
// {
//   ManagedServo(10, 30, 110, 30, false),  // Index Lower   0  ← D10
//   ManagedServo(1,  30, 140, 30, true),   // Index Upper   1  ← D1
//   ManagedServo(12, 30, 120, 30, false),  // Middle Lower  2  ← D12
//   ManagedServo(11, 30, 150, 150, true),   // Middle Upper  3  ← D11
//   ManagedServo(6,  30, 150, 30, true),   // Ring Lower    4  ← D6
//   ManagedServo(8,  90, 150, 150, false),  // Ring Upper    5  ← D8
//   ManagedServo(7,  30, 140, 30, true),   // Pinky Lower   6  ← D7
//   ManagedServo(9,  30, 100, 30, false),  // Pinky Upper   7  ← D9
//   ManagedServo(15, 30, 100, 30, false),  // Index Tip     8  ← D15
//   ManagedServo(13, 30, 90,  30, false),  // Middle Tip    9  ← D13
//   ManagedServo(2,  30, 120, 30, true),   // Ring Tip     10  ← D2
//   ManagedServo(0,  30, 130, 30, true),   // Pinky Tip    11  ← D0
//   ManagedServo(17, 30, 130, 120, false),  // Thumb Tip    12  ← D17
//   ManagedServo(14, 30, 150, 30, false),  // Thumb Right  13  ← D14
//   ManagedServo(16, 20, 120, 20, false),  // Thumb Left   14  ← D16
//   ManagedServo(5,  30, 90,  30, false),  // Thumb Rotate 15  ← D5
//   ManagedServo(4,  30, 160, 95, false),  // Wrist Left   16  ← D3
//   ManagedServo(3,  30, 160, 95, false)   // Wrist Right  17  ← D4
// };

ManagedServo managedServos[NUM_SERVOS] =
{
  ManagedServo(10, 0, 180, 30,  false),  // Index Lower   0
  ManagedServo(1,  0, 180, 30,  true),   // Index Upper   1
  ManagedServo(12, 0, 180, 30,  false),  // Middle Lower  2
  ManagedServo(11, 0, 180, 150, true),   // Middle Upper  3
  ManagedServo(6,  0, 180, 30,  true),   // Ring Lower    4
  ManagedServo(8,  0, 180, 150, false),  // Ring Upper    5
  ManagedServo(7,  0, 180, 30,  true),   // Pinky Lower   6
  ManagedServo(9,  0, 180, 30,  false),  // Pinky Upper   7
  ManagedServo(15, 0, 180, 30,  false),  // Index Tip     8
  ManagedServo(13, 0, 180, 30,  false),  // Middle Tip    9
  ManagedServo(2,  0, 180, 30,  true),   // Ring Tip     10
  ManagedServo(0,  0, 180, 30,  true),   // Pinky Tip    11
  ManagedServo(17, 0, 180, 120, false),  // Thumb Tip    12
  ManagedServo(14, 0, 180, 30,  false),  // Thumb Right  13
  ManagedServo(16, 0, 180, 20,  false),  // Thumb Left   14
  ManagedServo(5,  0, 180, 30,  false),  // Thumb Rotate 15
  ManagedServo(4,  0, 180, 95,  false),  // Wrist Left   16
  ManagedServo(3,  0, 180, 95,  false),  // Wrist Right  17
};

GesturePlayer gesturePlayer(managedServos, NUM_SERVOS);
...
// Gesture player service
BLEService gestureService("7def8317-7300-4ee6-8849-46face74ca2a");

// Gesture player characteristic (max 20-byte binary packets, same as rxChar)
BLECharacteristic gestureCharacteristic("7def8317-7301-4ee6-8849-46face74ca2a", BLEWrite, 20);


// Heartbeat timer
uint32_t heartbeat = 0;
UniversalTimer heartbeatTimer(10000, true);  // 5 second message interval

// Connection timeout timer
UniversalTimer connectionTimeout(30000, true); // 10 second timeout
...
void setup() {
  ...
  gestureService.addCharacteristic(gestureCharacteristic); // Add the gestureCharacteristic
  ...
  gestureCharacteristic.setEventHandler(BLEWritten, gestureHandler);  // Assign event handler for characteristic
...
void gestureHandler(BLEDevice central, BLECharacteristic characteristic) {
  const uint8_t* data = characteristic.value();
  const uint16_t len  = (uint16_t)characteristic.valueLength();
  gesturePlayer.handlePacket(data, len);
}
